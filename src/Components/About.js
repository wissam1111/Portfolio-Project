...
export default function About(){
  return(
    <div className="max-w-4xl mx-auto p-6 bg-gray-50 rounded-lg shadow-lg">
      <h1 className="text-3xl font-extrabold text-gray-800 mb-4">About Me</h1>
      <p className="text-lg text-gray-700 mb-4">
        Hi, I'm <span className="font-semibold text-blue-600">Wissam</span>, a passionate web developer with a love for creating dynamic and engaging web applications. I specialize in front-end development, focusing on technologies such as <span className="font-semibold text-blue-600">React</span>, <span className="font-semibold text-blue-600">JavaScript</span>, and <span className="font-semibold text-blue-600">Tailwind CSS</span>. My journey into web development began with a fascination for how interactive websites are built and a desire to bring creative ideas to life.
      </p>
      <p className="text-lg text-gray-700 mb-4">
